...
class SendEmail
{
    ...
    private static $From = '3298984708@qq.com'; //发送者的邮件地址
    private static $FromName = '人体解剖学绘图集小程序'; //发送邮件的用户昵称
    private static $Username = '3298984708@qq.com'; //登录到邮箱的用户名
    private static $Password = 'mglojztpjbobdbbh'; //第三方登录的授权码，在邮箱里面设置
     ...
     */
    public static function SendEmail($title='人体解剖学绘图集小程序',$message='服务器发生异常！请及时处理！',$emailAddress)
    {
        $mail = new PHPMailer();
